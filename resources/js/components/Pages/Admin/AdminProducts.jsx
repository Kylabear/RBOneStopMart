        ...
        <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 admin-page py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-gray-700">Manage your product catalog</p>
                </div>
                ...
                <div className="glass-card rounded-2xl p-6 mb-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <button className="bg-blue-600 hover:bg-blue-700 text-black px-6 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center space-x-2">
                ...
                <div className="glass-card rounded-2xl overflow-hidden">
                        ...
                        <table className="w-full">
                            <thead className="bg-white/5">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 text-left text-black font-semibold">Price</th>
                                    <th className="px-6 py-4 text-left text-black font-semibold">Stock</th>
                    ...
                    {products?.data?.length === 0 && (
                        <div className="text-center py-12">
                            ...
                            <button className="bg-blue-600 hover:bg-blue-700 text-black px-6 py-3 rounded-lg font-semibold transition-colors">
